...
class NoteRepositoryImplTest {
    ...
    @Test
    fun saveNotePassesCorrectDataToDataSource() =
        runBlocking {
            val note =
                Note(
                    id = "",
    ...
    @Test
    fun getAllNotesReturnsAllSavedNotes() =
        runBlocking {
            val note1 =
                Note(
                    id = "1",
    ...
    @Test
    fun getAllNotesReturnsEmptyListWhenDataSourceEmpty() =
        runBlocking {
    ...
    @Test
    fun getAllNotesPropagatesFailure() =
        runBlocking {
            dataSource.shouldFail = true
    ...
    @Test
    fun getNoteByIdReturnsCorrectNote() =
        runBlocking {
            val note =
                Note(
                    id = "1",
    ...
    @Test
    fun getNoteByIdPropagatesFailure() =
        runBlocking {
            dataSource.shouldFail = true
    ...
    @Test
    fun deleteNotePropagatesFailure() =
        runBlocking {
            dataSource.shouldFail = true
    ...
    @Test
    fun moveToTrashPropagatesFailure() =
        runBlocking {
            dataSource.shouldFail = true
    ...
    @Test
    fun archiveNotePropagatesFailure() =
        runBlocking {
            dataSource.shouldFail = true
    ...
    private class FakeNotesDataSource : NotesDataSource {
        ...
        var noteById: NoteWithAttachments =
            NoteWithAttachments(
        ...
        override fun getAllNotesFlow(): Flow<Result<List<Note>>> =
            flow {
                if (shouldFail) {
                    emit(Result.Failure(RuntimeException("test failure")))
                } else {
